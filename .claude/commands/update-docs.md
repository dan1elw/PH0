...
2. Check which docs need updating: README.md, docs/ARCHITECTURE.md, docs/SETUP.md, docs/TROUBLESHOOTING.md
...
4. If the repository structure changed, update the tree in README.md
